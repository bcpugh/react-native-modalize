...
class Modalize extends React.Component {
    constructor(props) {
        ...
        this.onHandleChildren = ({ nativeEvent }) => {
            const { snapPoint, useNativeDriver, adjustToContentHeight, alwaysOpen, closeAnimationConfig, dragToss = 0.05, } = this.props;
        ...
        const fullHeight = utils_1.isIos
            ? screenHeight
            : screenHeight - (utils_1.isIos ? react_native_1.StatusBar.currentHeight || 0 : 10);
